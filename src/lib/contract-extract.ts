...
function mockTerms(name: string, pbm: string): ContractTermsT {
  ...
  return {
    ...
    remittance: { payerNamesOnRemittance: [], payerIdentifiers: [], paidBy: pbm, paymentMethod: "EFT", paymentCycle: "twice monthly", eraOffered: true, enrollmentMethod: "Provider portal, EFT/ERA enrollment form", enrollmentFormUrl: "https://portal.example.invalid/era-enrollment", clearinghouse: "Example Clearinghouse", tradingPartnerId: "TP00000", remittanceContact: "providerpayments@example.invalid", citation: cite },
