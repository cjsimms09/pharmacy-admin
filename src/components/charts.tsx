...
/**
 * Charts, only where a trend is the point.
 *
 * Plain SVG, no library: a bar is a rectangle and the number is printed on it, so the chart is
 * read rather than interpreted. Every bar is a link to the rows it was drawn from, because a
 * chart that cannot be opened is decoration.
 */
