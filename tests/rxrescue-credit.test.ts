...
const MEMO = [
  ...
  "d1da64b5-1398-4f5e-9e96-b242a1197011,000000990301,99991001,70165030030,Cotempla,2026-08-10,7000017,WEST WICHITA FAMILY PHARMACY,03,30.0,0.0,538.7,0.0,50.0,511.2,22.5,511.2,C-00004862C20260815,2026-09-03",
...
describe("reading a credit memo", () => {
  ...
  test("the credit is the top-off plus the assistance, and a line that disagrees is reported", () => {
    ...
    const bent = parseRxRescueCredit(
      [HEAD, "x,000000111,1,62542002030,X,2026-08-13,7000017,P,08,30.0,0.0,0.0,10.0,0.0,20.0,0.0,999.0,M,2026-09-03"].join("\n"),
    );
